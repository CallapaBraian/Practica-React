...
import "../styles.css"; // importante: subir un nivel porque ahora está en /pages
...
export default function Home() {
  ...
  const mostrarError = useCallback((m) => {
    setMsg(m);
    setTipo("err");
  }, []);

  const mostrarOk = useCallback((m) => {
    setMsg(m);
    setTipo("ok");
  }, []);
    ...
    <div className="page">
      <main className="container">
        ...
        >
          ...
          >
            ...
            />
            <small id="hint">
              Formatos: PNG, JPG, GIF, SVG, WebP. Máx. 10 MB.
            </small>
          </div>
        </section>
      ...
      <footer className="footer">
        <div className="footer-inner">
          <p>
            TP2/TP3 — React + File API (File, FileReader) + Drag & Drop —
            Lenguaje IV
          </p>
          <button
            type="button"
